...
LevelSizeLoad:
		moveq	#0,d0
		move.b	d0,(v_dle_routine-2).w
		move.b	d0,(v_dle_routine-1).w
		move.b	d0,(f_nobgscroll+2).w
		move.b	d0,(f_nobgscroll+4).w
...
LevelSizeArray:
		...
		dc.w $0004, $0000, $2D00, $0000, $0300, $0060
		; MZ
		...
		dc.w $0004, $0000, $28C0, $0000, $0080, $0060
		; SYZ
		...
		dc.w $0004, $0000, $4000, $0000, $0080, $0060
...
SetScr_WithinBottom:
		...
		move.b	(v_zone).w,d0
		lsl.b	#2,d0
		lea	LoopTileNums(pc),a1
		move.l	(a1,d0.w),(v_256loop1).w
		rts
; ===========================================================================
; ---------------------------------------------------------------------------
...
; 		loop	loop	tunnel	tunnel
	...
	dc.b	$AD,	$7F,	$1D,	$1E	; Green Hill
	dc.b	$AD,	$7F,	$7F,	$7F	; Labyrinth
