...
ptr_TAZSpikeBall:	dc.l TAZSpikeBall
...
ptr_SuperSonic:		dc.l SuperSonic
...
ptr_TrueFinalBoss:	dc.l TrueFinalBoss
ptr_SonicTeam:		dc.l SonicTeam
...
id_Planet:			equ ((ptr_Planet-Obj_Index)/4)+1
id_TEncore:			equ ((ptr_TEncore-Obj_Index)/4)+1
...
id_TAZSpikeBall:	equ ((ptr_TAZSpikeBall-Obj_Index)/4)+1
...
id_TrainBoss:		equ ((ptr_TrainBoss-Obj_Index)/4)+1
...
id_SuperSonic:		equ ((ptr_SuperSonic-Obj_Index)/4)+1
...
id_TrueFinalBoss:	equ ((ptr_TrueFinalBoss-Obj_Index)/4)+1
id_SonicTeam:		equ ((ptr_SonicTeam-Obj_Index)/4)+1
