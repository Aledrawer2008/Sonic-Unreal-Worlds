...
LZWaterFeatures:
		...
		beq.w	.notlabyrinth	; if not, branch
        ...
        cmpi.b  #1,(v_zone).w
        bne.s   .setheight     ; don't load this in any other zone
		bsr.w	LZWindTunnels
		bsr.w	LZWaterSlides
...
; ===========================================================================
DynWater_Index:
        dc.w locret_3FBE-DynWater_Index
        dc.w locret_3FBE-DynWater_Index
        dc.w locret_3FBE-DynWater_Index
        dc.w locret_3FBE-DynWater_Index
        dc.w DynWater_LZ1-DynWater_Index    ; LZ1  is here
        dc.w DynWater_LZ2-DynWater_Index    ; LZ2  is here
        dc.w DynWater_LZ3-DynWater_Index    ; LZ3  is here
        dc.w DynWater_SBZ3-DynWater_Index   ; SBZ3 is here
        dc.w locret_3FBE-DynWater_Index
        dc.w locret_3FBE-DynWater_Index
        dc.w locret_3FBE-DynWater_Index
        dc.w locret_3FBE-DynWater_Index
