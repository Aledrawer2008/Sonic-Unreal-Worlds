...
End_LoadData:
		...
		move.l	#Col_Ending,(v_collindex).w ; load collision index
		enable_ints
		locVRAM	$7C20	; Set location in VRAM
		lea	(Nem_EndSonic).l,a0	; Load Sonic art
		tst.b	(v_character).w	; Before Decompressing, are you playing as Amy?
		beq.s	.skip	; If not, skip the 2nd write to a0
		lea	(Nem_EndAmy).l,a0	; Load Amy art
.skip:
