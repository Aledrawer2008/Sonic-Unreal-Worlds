...
.valid:
		...
		btst	#7,obStatus(a0)	; was dropdash flag set?
...
Sonic_JumpDash:
		...
		andi.b	#btnB+btnC,d0	; is ABC pressed? (part 2)
		beq.w	.End	; if not, branch
		btst	#7,obStatus(a0)	; was jumpdash flag set?
		bne.w	.End	; if yes, branch
		bset	#7,obStatus(a0)	; if not, set jumpdash flag
