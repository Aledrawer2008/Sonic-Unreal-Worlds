...
ReactToItem:
		...
		subq.b	#3,d5
		sub.w	d5,d3
		cmpi.b	#fr_Duck2,obFrame(a0) ; is Sonic ducking?
...
.movingdown:
		cmpi.b	#id_Warp,obAnim(a0) ; is Sonic rolling/jumping?
		bne.s	.skip
...
.lessthan16:
		bsr.w	AddPoints
		_move.b	#id_ExplosionItem,0(a1) ; change object to ring
...
PointsIndex:	dc.w 10, 20, 50, 100	; points awarded div 10
...
HurtSonic:
		tst.b	(v_bossstatus).w	; did Sonic defeated Eggman?
		bne.w	.postboss	; if yes, branch
...
KillSonic:
		...
		beq.s    .lava       ; if yes, branch
		cmpi.b    #$35,(a2)    ; check if you were killed by fireball
		beq.s    .lava       ; if yes, branch
		cmpi.b    #$54,(a2)    ; check if you were killed by lava
		beq.s    .lava       ; if yes, branch
		cmpi.b    #$6D,(a2)    ; check if you were killed by flamethrower
		beq.s    .lava        ; if yes, branch
		move.b	#id_Death,obAnim(a0) ;if non of the previous, set the death anim...
        bra.s    .common     ;...and branch
.lava
