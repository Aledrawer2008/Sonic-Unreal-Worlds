...
Sonic_BalanceLeft:
		...
		move.b	#id_Balance2,obAnim(a0) ; use forward balancing animation
...
Sonic_BalanceBackward:
		move.b	#id_Balance,obAnim(a0) ; use backward balancing animation
