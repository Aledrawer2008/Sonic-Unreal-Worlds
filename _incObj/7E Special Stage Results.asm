...
SSR_RingBonus:	; Routine 6
		...
		jmp	(PlaySound_Special).l	; play glass sound
; ===========================================================================
...
loc_C8C4:
		...
		move.w	#60,$34(a0) ; set time delay to 1 second
...
SSR_Continue:	; Routine $E
		...
		addq.b	#2,obRoutine(a0)
		move.w	#360,$34(a0) ; set time delay to 6 seconds
		bra.w	DisplaySprite
; ===========================================================================
