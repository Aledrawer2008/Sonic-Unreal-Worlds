...
;			| Filename	| Folder
		...
		incdac	OuttaHere,	"Sound/DAC/I'm Outta Here.wav"
		incdac	OuttaHereAmy,	"Sound/DAC/I'm Outta Here - Amy.wav"
		incdac	ThankYou,	"Sound/DAC/Thanks for playing.wav"
		incdac	MeAndoM,	"Sound/DAC/Thanks for playing - Alt.wav"
		incdac	KickAlt,	"Sound/DAC/Kick.wav"
