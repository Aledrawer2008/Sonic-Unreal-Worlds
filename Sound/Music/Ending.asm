...
Snd_Ending_DAC:
	...
	dc.b	nRst, dElectricLowTom, dElectricLowTom, dElectricFloorTom, nRst, dCrashCymbal, $06, nRst, nRst, nRst, dSnareAlt, nRst
	dc.b	nRst, dSnareAlt, nRst, nRst, dKick, nRst, dSnareAlt, dKick, dKick, nRst, dKick, $06
	dc.b	nRst, nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt, nRst, nRst, dKick, nRst, dSnareAlt
	dc.b	dKick, dKick, nRst, dKick, $06, nRst, nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt
	dc.b	nRst, nRst, dKick, nRst, dSnareAlt, dKick, dKick, nRst, dKick, $06, nRst, nRst
	dc.b	nRst, dSnareAlt, nRst, nRst, dSnareAlt, nRst, nRst, dKick, nRst, dSnareAlt, dKick, dKick
	dc.b	nRst, dCrashCymbal, $06, nRst, nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt, dKick, nRst
	dc.b	dKick, nRst, dSnareAlt, nRst, dKick, dKick, dKick, $06, nRst, nRst, nRst, dSnareAlt
	dc.b	nRst, nRst, dSnareAlt, dKick, nRst, dSnareAlt, nRst, dSnareAlt, nRst, dSnareAlt, dSnareAlt, dKick
	dc.b	$06, nRst, nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt, dKick, nRst, dKick, nRst
	dc.b	dSnareAlt, nRst, dKick, dKick, dKick, $06, nRst, nRst, nRst, dSnareAlt, nRst, nRst
	dc.b	dSnareAlt, dKick, nRst, dSnareAlt, dSnareAlt, dSnareAlt, dSnareAlt, dSnareAlt, dSnareAlt, dCrashCymbal, $06, nRst
	dc.b	nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt, nRst, nRst, dKick, nRst, dSnareAlt, dKick
	dc.b	dKick, nRst, dKick, $06, nRst, nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt, nRst
	dc.b	nRst, dKick, nRst, dSnareAlt, dKick, dKick, nRst, dKick, $06, nRst, nRst, nRst
	dc.b	dSnareAlt, nRst, nRst, dSnareAlt, nRst, nRst, dKick, nRst, dSnareAlt, dKick, dKick, nRst
	dc.b	dKick, $06, nRst, nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt, nRst, nRst, dKick
	dc.b	nRst, dSnareAlt, dKick, dKick, nRst, dCrashCymbal, $06, nRst, nRst, nRst, dSnareAlt, nRst
	dc.b	nRst, dSnareAlt, dKick, nRst, dKick, nRst, dSnareAlt, nRst, dKick, dKick, dKick, $06
	dc.b	nRst, nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt, dKick, nRst, dSnareAlt, nRst, dSnareAlt
	dc.b	nRst, dSnareAlt, dSnareAlt, dKick, $06, nRst, nRst, nRst, dSnareAlt, nRst, nRst, dSnareAlt
	dc.b	nRst, nRst, dKick, nRst, dSnareAlt, dKick, dKick, nRst, dSnareAlt, dSnareAlt, dSnareAlt, dKick
	dc.b	nRst, dSnareAlt, dKick, dSnareAlt, dSnareAlt, nRst, dSnareAlt, nRst, dKick, dSnareAlt, dSnareAlt, dCrashCymbal
	smpsStop
