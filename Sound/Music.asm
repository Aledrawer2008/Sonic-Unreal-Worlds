...
ptr_mus21:	SMPS_MUSIC_METADATA	SuperThemeAmy, s1TempotoS3($05), 0	; Super Theme (Amy)
ptr_mus22:	SMPS_MUSIC_METADATA	CreditsTheme, s1TempotoS3($0A), 0	; Credits
ptr_mus23:	SMPS_MUSIC_METADATA	TrueEnding, s1TempotoS3($0A), 0		; Credits (True Ending)
ptr_mus24:	SMPS_MUSIC_METADATA	GameOverTheme, s1TempotoS3($13), 0	; Game Over
ptr_mus25:	SMPS_MUSIC_METADATA	ChaosEmerald, s1TempotoS3($10), 0	; Emerald
ptr_mus26:	SMPS_MUSIC_METADATA	Drowning, s1TempotoS3($02), SMPS_MUSIC_METADATA_FORCE_PAL_SPEED			; Drowning
ptr_mus27:	SMPS_MUSIC_METADATA	ContinueScreen, s1TempotoS3($07), SMPS_MUSIC_METADATA_FORCE_PAL_SPEED	; Continue
...
ptr_mus2C:	SMPS_MUSIC_METADATA	SpecialClear, s1TempotoS3($05), 0 	; Special Stage Clear
ptr_musend
...
SuperTheme:		include		"Sound/Music/Super Theme.asm"
		even
SuperThemeAmy:	include		"Sound/Music/Super Theme 2.asm"
		even
...
TeamEncore:		include		"Sound/Music/Team Encore Screen.asm"
		even
SpecialClear:	include		"Sound/Music/Special Stage Clear.asm"
		even