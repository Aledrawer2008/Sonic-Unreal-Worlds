...
bgm_CreditsAlt =	SMPS_id(ptr_mus22)
bgm_GameOver =		SMPS_id(ptr_mus23)
bgm_Emerald =		SMPS_id(ptr_mus24)
bgm_Drowning =		SMPS_id(ptr_mus25)
bgm_Continue =		SMPS_id(ptr_mus26)
bgm_Sega =		SMPS_id(ptr_mus27)
