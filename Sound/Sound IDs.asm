...
bgm_SuperThemeB =	SMPS_id(ptr_mus21)
bgm_Credits =	SMPS_id(ptr_mus22)
bgm_CreditsB =	SMPS_id(ptr_mus23)
bgm_GameOver =	SMPS_id(ptr_mus24)
bgm_Emerald =	SMPS_id(ptr_mus25)
bgm_Drowning =	SMPS_id(ptr_mus26)
bgm_Continue =	SMPS_id(ptr_mus27)
bgm_Cutscene =	SMPS_id(ptr_mus28)
bgm_UBZ =		SMPS_id(ptr_mus29)
bgm_TAZ =       SMPS_id(ptr_mus2A)
bgm_Encore =    SMPS_id(ptr_mus2B)
bgm_SSClear =   SMPS_id(ptr_mus2C)
