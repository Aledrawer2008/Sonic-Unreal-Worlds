...
SoundCF:	include "Sound/SFX/SndCF - Signpost.asm"
	even
SoundD2:	include "Sound/SFX/SndD2 - DropDash.asm"
	even
SoundD3:	include "Sound/SFX/SndE6 - CDCharge.asm"
	even
SoundD4:	include "Sound/SFX/SndE7 - CDRelease.asm"
	even
SoundD5:	include "Sound/SFX/SndE8 - CDStop.asm"
	even
